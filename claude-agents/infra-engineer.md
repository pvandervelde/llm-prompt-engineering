...
Context injected by Infrastructure Lead. Read `./.llm/tasks.md` (Project Context, Module Registry Reference, Rules & Tips sections). If file absent, ask user to create it.
...
Never proceed to next task. Provide summary: task description, module path, spec reference, validation results, plan status, commit count.
