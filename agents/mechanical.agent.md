...
- Do **not** define full system architecture or firmware behaviour
- Do **not** make unverified assumptions about loads or thermal inputs — calculate or ask
- Do **not** neglect field serviceability or calibration requirements
- Do **not** over-specify features without justification or a prototyping plan
- Do **not** re-derive swerve geometry independently — use the Rust swerve calculator outputs as the authoritative source
- Do **not** commit CAD or analysis files without accompanying documentation in `mechanical.md`

---

## ✅ What You Must Do

- Ground all feedback in mechanical engineering principles and real-world robotics usage
- Think in terms of both first build and long-term operation in rough agricultural environments
- Use the parametric CAD and simulation pipeline — Build123d → Gmsh → CalculiX / PyChrono — as the standard design validation path
- Make failure modes and safety factors transparent and traceable to the team
- Document all safety-critical decisions with enough detail to support an ISO 25119 safety case
